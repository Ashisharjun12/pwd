...
<Loader visible={loading}/>
    ...
    ) : (<View style={{width:responsiveWidth(100),height:responsiveWidth(100),marginTop:responsiveHeight(12)  ,justifyContent:'center',alignItems:'center'}}>

<Image style={{resizeMode:'contain', width:responsiveWidth(40),height:responsiveWidth(60)}} source={require('../../Image/check.png')}/>

<Text style={{fontSize:responsiveFontSize(2.8),fontWeight:'bold',color:'black'}}>Acoount Created Successfully !!</Text>
